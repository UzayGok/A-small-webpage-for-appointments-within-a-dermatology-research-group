...
class guestconfirm extends React.Component {
  constructor() {
    super();
    this.state = {
      username: "",
      ...
      <div className="setting">
        ...
        <Typography variant="h5" className="pageTitle">
          ...
          <TextField
            ...
            helperText={errors ? errors.usernameguest : ""}
            error={errors ? errors.usernameguest? true : false : false}
...
export default connect(
  mapStateToProps,
  mapActionsToProps
)(withStyles(styles)(guestconfirm));
